        ...
        with gff_path.open("r", encoding="utf-8") as handle:
            for line in handle:
                ...
                product = _first_non_empty(
                    attributes, ["product", "description", "Note"]
                )

                for feature_id in feature_ids:
                    record = annotation_lookup.get(
                        feature_id,
    ...
    volcano_spec = {
        ...
        "data": [
            {
                ...
                "transform": [
                    ...
                    },
                    {
                        "type": "filter",
                        "expr": (
                            "isValid(datum.log2FoldChange) && isFinite(datum.log2FoldChange) && "
                    ...
                    },
                    {
                        "type": "formula",
                        "as": "neg_log10_p",
                        "expr": "-log(datum.plot_p)/LN10",
                    },
                    {
                        "type": "formula",
                        "as": "abs_lfc",
                        "expr": "abs(datum.log2FoldChange)",
                    },
                    {
                        "type": "formula",
                        "as": "sig_flag",
        ...
        "axes": [
            {"orient": "bottom", "scale": "x", "title": "log2 fold change"},
            {
                "orient": "left",
                "scale": "y",
                "title": "-log10 adjusted p-value (fallback to p-value)",
            },
        ],
        "legends": [
        ...
        "marks": [
            ...
            },
            {
                ...
                "encode": {
                    ...
                    "hover": {"opacity": {"value": 1}, "size": {"value": 100}},
                },
            },
            {
                "type": "text",
...
def _write_visualization_output(
    ...
    (output_path / "deseq2_summary.txt").write_text(
        run_result.summary, encoding="utf-8"
    )
